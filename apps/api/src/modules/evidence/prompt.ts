...
export const PROMPT_SPAN_PROPOSAL_VERSION = "0.1.0";

export const PROMPT_REVIEW_ID = "PT-06";
export const PROMPT_REVIEW_VERSION = "0.1.0";
...
- Return ONLY a JSON object matching ProposeEvidenceSpansOutputSchema.`;
...
- Return ONLY a JSON object matching EvidenceReviewOutputSchema.`;
...
export const PROMPT_RECORDS = {
  spanProposal: {
    ...
    contentHash: "sha256-span-proposal",
