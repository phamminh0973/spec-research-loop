...
export const PROMPT_QUERY_GENERATION_VERSION = "0.1.0";

export const PROMPT_PAPER_ANALYSIS_ID = "PT-04";
export const PROMPT_PAPER_ANALYSIS_VERSION = "0.1.0";
...
- Return ONLY a JSON object matching QueryGenerationOutputSchema.`;
...
- Return ONLY a JSON object matching SearchWithAnalysisOutputSchema.`;
...
export const PROMPT_RECORDS = {
  ...
  paperAnalysis: {
    ...
    taskId: TASK_ID,
    schemaVersion: SCHEMA_VERSION,
    contentHash: "sha256-paper-analysis",
