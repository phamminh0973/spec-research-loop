...
| TT-US09-01 | US-09             | Implement upload validation, private local storage and `pdfjs-dist`/`pdf-parse` page extraction. | Member 2             |
...
| Redis + BullMQ/full progress | Platform Quality              | US-21 stable       | Observed job lifetime/recovery need justifies queue |
