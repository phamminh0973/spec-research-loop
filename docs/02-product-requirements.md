...
| Platform Quality                    | Validation, limits, logging, security, tests, reproducible setup                  | Redis/BullMQ nếu cần, cost dashboard           | Advanced observability                                                 |
...
- P0 có thể chạy small jobs in-process sau persisted job abstraction; Redis/BullMQ là P1.
