    ...
    <SectionCard className="mt-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="whitespace-nowrap text-lg font-bold text-ink">Tóm tắt sau vòng 4</span>
        </div>

        {/* Breadcrumb */}
        <div className="flex-1 lg:px-6">
          <StepBreadcrumb currentStep={4} totalSteps={5} steps={STEPS} />
        </div>
        ...
        <div className="flex items-start gap-3 rounded-xl border border-brand-muted bg-brand-soft p-4 lg:max-w-sm">
          ...
          <p className="text-sm leading-relaxed text-brand-strong">
            <span className="font-semibold">Gợi ý:</span> Judge giúp phản biện độc lập; người dùng
            vẫn là người quyết định cuối cùng.
          </p>
        </div>
      </div>
    </SectionCard>
