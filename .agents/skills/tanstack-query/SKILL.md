---
name: tanstack-query
description: Use when TanStack Query is actually adopted in SpecResearch Loop's web app, including useQuery, useMutation, query keys, cache invalidation, optimistic updates, server-state loading, or query testing. Do not assume the dependency is installed.
---
